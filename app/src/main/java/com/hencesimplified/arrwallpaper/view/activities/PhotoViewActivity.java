...
public class PhotoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_setwall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog alert_dia1 = new androidx.appcompat.app.AlertDialog.Builder(PhotoViewActivity.this).create();
    ...
    public boolean checkPermission(String permission) {
        ActivityCompat.requestPermissions(PhotoViewActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
