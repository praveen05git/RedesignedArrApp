...
import com.hencesimplified.arrwallpaper.view.fragments.EventsFragmentDirections;
import com.squareup.picasso.Picasso;

import java.util.List;

public class EventsPhotosViewAdapter extends RecyclerView.Adapter<EventsPhotosViewAdapter.PhotosViewHolder> {

    private List<PhotoData> photosList;

    public EventsPhotosViewAdapter(List<PhotoData> photosList) {
    ...
    public void onBindViewHolder(@NonNull PhotosViewHolder holder, final int position) {
        ...
        photoCardView.setOnClickListener(view -> {
            ...
            EventsFragmentDirections.EventToPhotos eventToPhotos = EventsFragmentDirections.eventToPhotos();
            eventToPhotos.setPhotoUrl(img);
            Navigation.findNavController(photoCardView).navigate(eventToPhotos);
        });
    }
